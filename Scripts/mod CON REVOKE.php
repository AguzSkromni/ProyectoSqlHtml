    ...
    <header class="cover">
        <div class="contenedor contenido-header">
           <img src="logoUnitec.png" alt="logoUnitec" class="imagen-logo">
            <h1 class="h1class">Quitar Privilegios</h1>
        </div>
            ...
            <FIELdset>
                ...
                <?php else: ?>
                    ...
                    <?php else: ?>
                        ...
                        ?>
                        <form action="mod_user3 CON REVOKE.php" id="privilegios" method="post" title="User ID" size="10" maxlength="10">
                            <label>User ID: </label>
